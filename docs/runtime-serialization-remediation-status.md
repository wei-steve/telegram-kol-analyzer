...
| 6 | `phase-6-process-separation.md` | **planned; resume at Task 1 authority gate** — the prior SQLite three-process gate passed with 0/5400 SQLITE_BUSY, and completed Phase 6A removed the four known Web exchange-authority paths. Revalidate the full Task 1 decision gate in a separately claimed Phase 6 turn; no process split/deploy has occurred |
