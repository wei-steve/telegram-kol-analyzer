...
| 5 | `phase-5-queue-consumer-takeover.md` | **in_progress** — global/shadow; batch 119 resolved; claimed-job rollback race fixed locally, deploy and repeated boundary proof outstanding |
