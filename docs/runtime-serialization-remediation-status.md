...
phase_6r_observation_status: "NOT STARTED: post-apply whole critical-hash gate failed closed before L2 observation. Between consistent live-preapply and live-postapply online backups, the 128 planned decisions changed exactly as authorized, but concurrent production loops also changed execution_bindings (164 rows; recovered_at/updated_at in the first 100 detailed rows), execution_order_legs (24; updated_at and two last_verified_at), position_backup_stop_orders (2 updated_at), strategy_lifecycles (13 updated_at, including one lifecycle/entry transition), and added 42 pending_tpsl_snapshot_observations. These are recorded in live-unrelated-drift.json and cannot be called unchanged unrelated hashes. No 30-minute/5-message claim, SQLite_BUSY/duplicate/direct-exchange observation, or completion claim was made."
phase_6r_rollback_status: "Retained safe live state rather than applying rollback: the semantic switch is false, eligible review backlog is zero, exact target migration passed, service is active at Candidate 5e3cb63, active_write_count=0, and provider counters remain 6931 invocations/max id 14389/402 count 360 with notification count 6465. Targeted rollback remains currently evaluable for all 128 rows: live rollback plan SHA 10c53b7e573f23795495701dc7c74edd03a69d70b9a9b0fa42fdf388412be035, quick_check=ok, external counts zero. Applying it would recreate failed backlog and would not revert unrelated concurrent runtime writes, so it was not executed without a new explicit decision."
phase_6r_outstanding: "Owner decision is required because the phase's literal unchanged-unrelated-hash live gate is unsatisfied despite exact transaction target proof. Either explicitly accept the attributed concurrent runtime drift plus exact target-row CAS proof as the live evidence substitution and authorize the remaining L2 observation, or authorize a new maintenance-freeze plan for targeted rollback/reapply under stopped background writers. Do not improvise either path. Until then Phase 6R remains in_progress at safe live Candidate 5e3cb63 with semantic review disabled and zero eligible backlog. Phase 6A remains paused at its exact Task 12 blocker."
