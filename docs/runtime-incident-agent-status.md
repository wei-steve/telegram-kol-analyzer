...
local_tests:
  ...
  - "multi-target-final-focused-regression: 585 passed"
  ...
  - "management-target-agent-read-only: 49 focused tests and 8-case offline corpus passed; target playbook/action authority is structurally refused and production Agent selectors remain unchanged"
