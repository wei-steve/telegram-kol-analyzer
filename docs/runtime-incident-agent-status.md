...
production_commit: 534b247f8d3e1e3e4a336bca3117fd5a6bf9b28c
local_tests:
...
server_verification:
  ...
  remaining: "Phase 8R.3 stays in progress. The original 48-hour observation threshold elapsed on 2026-08-05 16:18 CST, but the required server-side comparison has not been performed in this turn. Before any selector widening or deployment, compare every scanner observation with its source row, confirm the source hash and zero scanner-created incidents/Telegram claims/Agent claims, re-run rollback and independent-monitor gates, and prove a fresh zero-in-flight window."
enabled_flags:
