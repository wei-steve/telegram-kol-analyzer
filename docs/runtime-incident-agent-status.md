...
message_operation_extension:
  ...
  allowed_symbol_contract_spec_status: shadow_active_live_requires_separate_approval
  ...
  allowed_symbol_contract_spec_activation_blocker: "Live mode requires a separate explicit operator approval after reviewing the recorded shadow evidence. Promotion must again prove a fresh quiet window, stable complete protection audits, healthy independent monitor, exact full-payload settings diff limited to shadow-to-live, and an immediate settings-only rollback path."
