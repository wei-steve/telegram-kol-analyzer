...
""".strip(),
    ...
    def fake_create_web_app(*, database_path, live_target_titles, runtime_role="all", ingest_refresh_url=None, media_root=None, live_listener_runner=None, telegram_client=None, live_listener_status_reason=None, live_listener_delegated=False, group_labels_by_title=None, now_provider=None, reconcile_runner=None, reconcile_interval_seconds=300, group_config=None, group_config_path=None, deepcoin_contract_spec_provider=None):
...
def test_alerts_command_starts_live_listener(tmp_path, monkeypatch):
    from telegram_kol_research.telegram_client import TelegramAuthConfig
