...
REVIEWED_PENDING_ENTRY_TARGETS = (
    ReviewedPendingEntryTarget(
        ...
        client_order_id="TKSQ3485E1",
        trigger_price="1827",
        size="3",
        embedded_stop_price="1795",
        take_profit_prices=("1860", "1885", "1925"),
    ...
    ReviewedPendingEntryTarget(
        ...
        client_order_id="TKSQ3507E1",
        trigger_price="61890",
        size="13",
        embedded_stop_price="60900",
        take_profit_prices=("63400", "64600", "66700"),
    ...
    ReviewedPendingEntryTarget(
        ...
        client_order_id="TKFG8798E1",
        trigger_price="2250",
        size="2.3",
        embedded_stop_price="2186",
        take_profit_prices=("2400",),
    ...
    ReviewedPendingEntryTarget(
        ...
        client_order_id="TKMYA604E1",
        trigger_price="73690",
        size="8",
        embedded_stop_price="72300",
        take_profit_prices=("76000",),
